...
func UpdateUserSetting(c *gin.Context) {
	...
	// Merge onto existing settings so language / billing / sidebar / routing caps are preserved.
	...
	// Clear notify-channel-specific fields, then re-apply for the selected type.
	settings.WebhookUrl = ""
