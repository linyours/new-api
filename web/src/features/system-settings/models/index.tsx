...
const defaultModelSettings: ModelSettings = {
  ...
  'general_setting.relay_timeout_seconds': 0,
  ...
  ChannelHealthErrorStatusCodes: '401-428,430-599',
  ChannelHealthMinTotal: 30,
  ChannelHealthAlertBelowPercent: 50,
  ChannelHealthWebhookUrl: '',
  ChannelHealthWebhookSecret: '',
