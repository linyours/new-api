...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/group_fallback", permission: authz.ChannelRead, handler: controller.GetGroupChannelFallbacks},
	{method: http.MethodPut, path: "/group_fallback", permission: authz.ChannelWrite, handler: controller.UpsertGroupChannelFallback},
	{method: http.MethodDelete, path: "/group_fallback", permission: authz.ChannelWrite, handler: controller.DeleteGroupChannelFallback},
