...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/group_fallback", controller.GetGroupChannelFallbacks)
			channelRoute.PUT("/group_fallback", controller.UpsertGroupChannelFallback)
			channelRoute.DELETE("/group_fallback", controller.DeleteGroupChannelFallback)
