...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		systemTaskRoute.Use(middleware.RootAuth())
		{
			...
			systemTaskRoute.POST("/error-log-truncate", controller.CreateErrorLogTruncateSystemTask)
			systemTaskRoute.POST("/error-log-retain", controller.CreateErrorLogRetainSystemTask)
